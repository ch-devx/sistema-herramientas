...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sb-links">
        ...
        <a href="/sistema-herramientas/modules/reportes/reporte_inventario.php" class="sb-link <?= strpos($_SERVER['PHP_SELF'], '/reportes/') !== false ? 'active' : '' ?>">
            <svg viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
            <span class="sb-link-txt">Reportes</span>
        </a>
